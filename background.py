...
pygame.display.set_caption('Adiing image and background image')
...
penguin_image = pygame.transform.scale(
    pygame.image.load('seaturtle.jpg').convert_alpha(), (200, 200))
penguin_rect = penguin_image.get_rect(center=(SCREEN_WIDTH // 2,
                                              SCREEN_HEIGHT // 2 - 30))
#initialize font, render text, and set text position
text = pygame.font.Font(None, 36).render('Hello Coding', True,
                                         pygame.Color('black'))
